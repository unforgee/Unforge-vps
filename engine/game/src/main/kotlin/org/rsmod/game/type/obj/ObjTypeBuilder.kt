...
public class ObjTypeBuilder(public var internal: String? = null) {
    ...
    public fun build(id: Int): UnpackedObjType {
        ...
        // The upstream cache may still contain opcode 16, and older content builders may set
        // this field. The legacy access flag is not a Unforge feature, so normalize it at the
        // type boundary instead of relying on every item consumer to remember a special case.
        val members = false
    ...
    public companion object : MergeableCacheBuilder<UnpackedObjType> {
        ...
        override fun merge(edit: UnpackedObjType, base: UnpackedObjType): UnpackedObjType {
            ...
            // Keep edited/merged item definitions free of the legacy access flag as well. This
            // prevents a legacy cache value from surviving after a type edit before repacking.
            val members = false
