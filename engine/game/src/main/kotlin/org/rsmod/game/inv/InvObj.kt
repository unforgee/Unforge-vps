...
constructor(
    ...
    public constructor(copy: InvObj) : this(copy.id, copy.count, copy.vars, copy.instanceId)

    public constructor(
        type: ObjType,
        count: Int = 1,
        vars: Int = 0,
        instanceId: Long = NO_INSTANCE,
    ) : this(type.id, count, vars, instanceId)

    public companion object {
        public const val NO_INSTANCE: Long = 0L
    }
}
