...
public class Obj(
    ...
    public val instanceId: Long = InvObj.NO_INSTANCE,
) {
    public val x: Int
        get() = coords.x
    ...
    public companion object {
        ...
        public fun fromPvp(killer: Player, target: Player, obj: InvObj): Obj {
            return fromPvp(killer, target, obj.id, obj.count, obj.instanceId)
        }
        ...
        private fun fromPvp(
            ...
            obj: Int,
            count: Int,
            instanceId: Long = InvObj.NO_INSTANCE,
        ): Obj {
        ...
        public fun fromPvn(killer: Player, target: Npc, obj: InvObj): Obj {
            return fromPvn(killer, target.coords, obj.id, obj.count, obj.instanceId)
        }
        ...
        public fun fromOwner(player: Player, coords: CoordGrid, obj: InvObj): Obj {
            return fromOwner(player, coords, obj.id, obj.count, obj.instanceId)
        }
        ...
        public fun fromServer(clock: MapClock, coords: CoordGrid, obj: InvObj): Obj {
            return fromServer(clock, coords, obj.id, obj.count, obj.instanceId)
        }
        ...
        private fun fromServer(
            ...
            return Obj(
                coords = coords,
                entity = entity,
                creationCycle = clock.cycle,
                receiverId = NULL_OBSERVER_ID,
                instanceId = instanceId,
            )
        }
