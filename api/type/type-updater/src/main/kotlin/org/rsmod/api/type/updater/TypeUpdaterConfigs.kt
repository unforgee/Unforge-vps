...
constructor(
    ...
    private fun collectUpdateMap(vanilla: TypeListMap): UpdateMap {
        ...
        // Components have no `MergeableCacheBuilder`, so they deliberately skip the merge step:
        // builders can only author brand-new components, never partially edit vanilla ones.
        val comps = build.comps + edit.comps
