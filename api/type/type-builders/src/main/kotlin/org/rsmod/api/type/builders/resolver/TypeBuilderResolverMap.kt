...
import org.rsmod.api.type.builders.interf.InterfaceBuilderResolver
...
constructor(
    ...
    private val interfResolver: InterfaceBuilderResolver,
    ...
    private fun <B, T> TypeBuilder<B, T>.resolver(): TypeBuilderResolver<B, T> {
        val resolver =
            when (this) {
                ...
                is InterfaceBuilder -> interfResolver
