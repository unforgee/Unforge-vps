...
import org.rsmod.api.account.character.equipment.EquipmentInstanceLoadPipeline
...
public object CharacterModule : ExtendedModule() {
    override fun bind() {
        ...
        addSetBinding<CharacterDataStage.Pipeline>(EquipmentInstanceLoadPipeline::class.java)
    }
}
