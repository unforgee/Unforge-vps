...
public object ClientScriptTypeDecoder {
    ...
    /** Trailer size as of OSRS 237+ (includes long local/arg counts). */
    private const val TRAILER_SIZE = 16
    ...
    public fun decode(builder: ClientScriptTypeBuilder, data: ByteBuf): Unit =
        with(builder) {
            ...
            val commandEndPosition =
                data.writerIndex() - Short.SIZE_BYTES - switchDataLength - TRAILER_SIZE
