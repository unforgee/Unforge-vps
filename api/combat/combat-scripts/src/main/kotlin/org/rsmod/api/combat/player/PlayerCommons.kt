...
internal suspend fun ProtectedAccess.activateMeleeSpecial(
    ...
    generic: GenericSpecials,
): Boolean {
    val weapon = attack.weapon ?: return false
    val special = specials[weapon] ?: generic.meleeFor(weapon) ?: return false
...
internal suspend fun ProtectedAccess.activateRangedSpecial(
    ...
    val special = specials[attack.weapon] ?: generic.rangedFor(attack.weapon) ?: return false
...
internal suspend fun ProtectedAccess.activateMagicSpecial(
    ...
    val special = specials[attack.weapon] ?: generic.magicFor(attack.weapon) ?: return false
