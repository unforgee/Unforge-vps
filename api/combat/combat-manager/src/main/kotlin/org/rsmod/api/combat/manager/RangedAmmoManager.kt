...
constructor(
    ...
    private fun useAmmo(
        ...
        // Companion bots are virtual players. Their equipment may contain a single loaded arrow,
        // but that arrow is an immutable loadout token and must not be consumed or dropped.
        if (player.username.startsWith("companion_")) return
