...
object BaseVarBits : VarBitReferences() {
    ...
    val spellbook_sublist = find("spellbook_sublist")
    val magic_filter_blockcombat = find("magic_filter_blockcombat")
    val magic_filter_blockutility = find("magic_filter_blockutility")
    val magic_filter_blocklacklevel = find("magic_filter_blocklacklevel")
    val magic_filter_blocklackrunes = find("magic_filter_blocklackrunes")
    val magic_filter_blockteleport = find("magic_filter_blockteleport")
    val magic_filter_blocklocked = find("magic_filter_blocklocked")
