...
object BaseParams : ParamReferences() {
    ...
    val npc_support_multiplier: ParamInt = find("npc_support_multiplier")
    val npc_support_healing_multiplier: ParamInt = find("npc_support_healing_multiplier")
    val npc_support_special_multiplier: ParamInt = find("npc_support_special_multiplier")
    val npc_pvm_tier: ParamInt = find("npc_pvm_tier")
    val npc_attack_type: ParamCategory = find("npc_attack_type")
    val npc_attack_style: ParamInt = find("npc_attack_style")
