...
internal object MusicDbColumns : DbColumnReferences() {
    ...
    /** Official music-region AreaType id (packed as INT, not AREA literal). */
    val area = int("music:area")
    /** When set, this track is the classic-mode default for [area]. */
    val area_default = int("music:area_default")
