...
public class ProtectedAccess(
    ...
    public val eventBus: EventBus by context::eventBus
    ...
    public fun objExamine(
        ...
        val instance = context.equipmentInstances[obj.instanceId] ?: return
        player.mesInstanceData(normalized, instance)
    }
    ...
    public suspend fun <T> choice2(
        ...
        val modal = player.ui.getModalOrNull(components.chatbox_chatarea)
        val input = coroutine.pause(ResumePauseButtonInput::class)
        resumePauseButtonWithProtectedAccess(
            input,
            modal,
            components.chatmenu_pbutton,
            modalTarget = components.chatbox_chatarea,
        )
    ...
    private fun resumePauseButtonWithProtectedAccess(
        ...
        modalTarget: ComponentType = components.chatbox_chatmodal,
    ) {
        ...
        resumeWithModalProtectedAccess(null, expectedModal, modalTarget)
    }
    ...
    public fun ifSetScrollPos(target: ComponentType, scrollPos: Int) {
        player.ifSetScrollPos(target, scrollPos)
    }
