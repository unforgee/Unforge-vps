...
public object MiscOutput {
    ...
    public fun updateRebootTimer(player: Player, cycles: Int) {
        ...
        player.client.write(UpdateRebootTimerV2(cycles, UpdateRebootTimerV2.IgnoreUpdateMessage))
    }

    /** Calls [UpdateRebootTimerV2] with an arg of `0` and a clear message. */
    public fun clearUpdateRebootTimer(player: Player) {
        player.client.write(UpdateRebootTimerV2(0, UpdateRebootTimerV2.ClearUpdateMessage))
    }
}
