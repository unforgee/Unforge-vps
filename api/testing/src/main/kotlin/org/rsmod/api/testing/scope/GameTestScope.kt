...
constructor(
    ...
    public class Builder(state: GameTestState, private val scripts: Set<KClass<out PluginScript>>) {
        ...
        private val nameMapping: NameMapping = state.nameMapping

        internal fun build(): GameTestScope {
            val module = TestModule(cacheTypes, collisionMap, nameMapping)
    ...
    private class TestModule(
        ...
        private fun bindInstances() {
            bind(NameMapping::class.java).toInstance(nameMapping)
            ...
            Multibinder.newSetBinder(
                binder(),
                org.rsmod.api.player.bonus.WornBonusesAugmenter::class.java,
            )

            Multibinder.newSetBinder(binder(), org.rsmod.api.death.PlayerDeathHook::class.java)
