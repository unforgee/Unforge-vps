...
internal constructor(
    ...
    override fun ScriptContext.startup() {
        ...
        // Open after EngineLogin high-priority packets (VarpReset / var transmit). Opening on
        // Initialize caused magic's onLoad CS2 (2262) to run before vars were authoritative.
        onEvent<SessionStateEvent.EngineLoginUi> { player.openLoginGameframe() }
    ...
    private fun Player.openLoginGameframe() {
        ...
        if (gameframe != null && gameframe.resizable == ui.frameResizable) {
            ...
            eventBus.publish(SessionStateEvent.EngineLoginReady(this))
            return
        }
