...
internal fun Player.setBankWornBonuses(wornBonuses: WornBonuses, weaponSpeeds: WeaponSpeeds) {
    ...
    val speedBase = weaponSpeeds.baseCenti(this)
    val speedActual = weaponSpeeds.actualCenti(this)
    ...
    ifSetText(comps.worn_speed_base, "Base: ${speedBase.centiTicksToSecs}")
    ifSetText(comps.worn_speed, "Actual: ${speedActual.centiTicksToSecs}")
