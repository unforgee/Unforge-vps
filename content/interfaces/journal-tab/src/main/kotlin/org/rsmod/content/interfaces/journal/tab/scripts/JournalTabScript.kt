...
class JournalTabScript @Inject constructor(private val eventBus: EventBus) : PluginScript() {
    override fun ScriptContext.startup() {
        ...
        onIfOverlayButton(journal_components.perk_list) {
            player.switchJournalTab(SideJournalTab.Perks)
        }

        onIfOverlayButton(journal_components.points_list) {
            player.switchJournalTab(SideJournalTab.Points)
        }
    }
